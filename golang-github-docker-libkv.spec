...
%global with_debug 0
# tests need etcd, consul and zookeeper available
%global with_check 0
...
%global commit          b68985b1d0224e002ce0e5dd5d08d06930d3be61
%global shortcommit     %(c=%{commit}; echo ${c:0:7})

Name:           golang-%{provider}-%{project}-%{repo}
Version:        0
Release:        0.10.git%{shortcommit}%{?dist}
Summary:        Key/Value store abstraction library
License:        ASL 2.0
...
Provides:      golang(%{import_path}/store/consul) = %{version}-%{release}
Provides:      golang(%{import_path}/store/etcd) = %{version}-%{release}
Provides:      golang(%{import_path}/store/mock) = %{version}-%{release}
Provides:      golang(%{import_path}/store/zookeeper) = %{version}-%{release}
...
%gotest %{import_path}
%gotest %{import_path}/store/consul
%gotest %{import_path}/store/etcd
%gotest %{import_path}/store/zookeeper
%endif
